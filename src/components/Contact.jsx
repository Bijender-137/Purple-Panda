      ...
      <section className="py-5"id="Contact">
        <Container>
          <Row className=" align-items-center">
            <Col lg={5} xl={6}data-aos="zoom-in">
              <img className="w-100" src={leaf} alt="leaf" />
            </Col>
            <Col lg={7} xl={6}>
              <article className="contact_blur px-3 py-4" data-aos="fade-left">
                ...
                <form className="" action="">
                  ...
                  <textarea
                    ...
                    rows="3"
                    placeholder="Message..."
                    className="mt-2 w-100 input_custom op_05 text-white ff_mons fw-normal fs_1x6l px-4 py-2 mb-4 mb-xl-5"
                  ></textarea>
                  <span>
                    <a
                      className="main_btn px-4 py-2 fw-bold fs_2xl ff_mons border-0"
                      href="#"
                    >
                      SUBMIT
                    </a>
