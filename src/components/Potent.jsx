...
function Potent() {
  return (
    <>
      <section className="aanimation bg_sec4 py-4 py-md-5 overflow-hidden min-vh-100 d-flex flex-column justify-content-center hello">
        <Container>
        ...
        <div className=" position-relative">
          ...
          <div className=" position-absolute top-50 start-50 translate-middle">
            ...
            <span className="  ">
              <a
                className=" white_space   main_btn px-4 py-2 fw-bold fs_2xl ff_mons "
                href="#"
              >
